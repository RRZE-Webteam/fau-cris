    ...
    private function make_list($activities, $name = 1, $year = 1, $activityname = 1, $showtype = 1): string
    {
        ...
        foreach ($activities as $activity) {
            ...
            if (!empty($activity_name)) {
                global $post;
                $activitylist .= " <strong><a href=\"" . Tools::get_item_url("activities", $activity_name, $activity_id, $post->ID, $this->page_lang) . "\" target=\"blank\" title=\"" . __('Detailansicht auf cris.fau.de in neuem Fenster &ouml;ffnen', 'fau-cris') . "\">" . $activity_name . "</a></strong>";
            }
