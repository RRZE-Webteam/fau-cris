    ...
    private function make_list($patents, $name = 1, $year = 1, $patentname = 1, $showtype = 1): string {
        ...
        foreach ($patents as $patent) {
            ...
            if (!empty($patent_name)) {
                $patentlist .= "<strong><a href=\"" . Tools::get_item_url("patents", $patent_name, $patent_id, $post->ID, $this->page_lang) . "\" title=\"" . __('Detailansicht auf cris.fau.de in neuem Fenster &ouml;ffnen', 'fau-cris') . "\">" . $patent_name . "</a></strong>";
            }
