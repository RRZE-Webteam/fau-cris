...
class Equipment
{
    ...
    private function make_custom($equipments, $custom_text = '', $param = array())
    {
        ...
        foreach ($equipments as $equipment) {
            ...
            $equipment_details['#description#'] = "<div class=\"equipment-description\">" . wp_strip_all_tags($description, '<br><a><sup><sub><ul><ol><li><b><p><i><strong><em>') . "</div>";
